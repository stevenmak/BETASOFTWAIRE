                                ...
                                <div class="d-flex">
                                    <div id="event-participant" class="avatar-group">
                                        <a href="#" class="avatar w-32 b-a b-white">
                                            <img src="{{ asset('assets/img/a0.jpg') }}">
                                        </a>
                                        <a href="#" class="avatar w-32 b-a b-white">
                                            <img src="{{ asset('assets/img/a2.jpg') }}">
                                        </a>
                                        <a href="#" class="avatar w-32 b-a b-white">
                                            <img src="{{ asset('assets/img/a3.jpg') }}">
                                        </a>
                                        <a href="#" class="avatar w-32 b-a b-white">
                                            <img src="{{ asset('assets/img/a4.jpg') }}">
                                        </a>
                                        <a href="#" class="avatar w-32 b-a b-white">
                                            <img src="{{ asset('assets/img/a5.jpg') }}">
                                        </a>
                                    </div>
