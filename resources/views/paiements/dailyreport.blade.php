...
<div class="padding">
    <div class="col-12">
        <h2 class="text-center">RAPPORT DES ENTREES</h2>
    </div>
</div>
<div class="row py-3">
        ...
        <tfoot>
            <tr>
                <td colspan="5" class="no-wrap">
                    <div class="text-right">Total du jour: {{ $entree=DB::table('paiements')->whereDate('datepaiement','=',Carbon\Carbon::today())->get(['montant'])->sum('montant')
                    }} $</div>
                </td>
            </tr>
        </tfoot>
