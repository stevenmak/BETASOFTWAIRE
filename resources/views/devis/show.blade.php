        ...
        <tfoot>
            <tr>
                <td colspan="4" class="text-right no-border">
                    ...
                    <strong class="text-success">{{ number_format($devis->montantdevis,2,',',' ') }}$</strong>
                </td>
            </tr>
            <tr>
                <td colspan="4" class="text-right no-border">
                    ...
                    <strong class="text-success">{{number_format($cdf,2,',',' ')  }} CDF</strong>
                </td>
            </tr>
        </tfoot>
    </table>
